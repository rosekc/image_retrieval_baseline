...
class ImageDataLoader:
    def __init__(self, root_dir, transforms=None, p=6, k=4, shuffle=True):
        self.p = p
        self.k = k
        self.batch_size = p * k
        ...
        self.paths = np.load(os.path.join(root_dir, 'train_paths.npy'))
    ...
    def flow(self):
        ...
        return ImageIterator(combined_data, self.p, self.k, len(self.classes), self.transforms, self.shuffle, None)
